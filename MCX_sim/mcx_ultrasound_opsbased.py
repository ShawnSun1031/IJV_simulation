...
class MCX:
    ...
    def __init__(self, sessionID):
        ...
        # load test mua
        with open(os.path.join(self.sessionID, "mua_test.json")) as f:
            self.mua_test = json.load(f)
    ...
    def createFolder(self):
        # set folder path        
        # main-path
        self.session = os.path.join(self.config["OutputPath"], self.config["SessionID"])        
        # sub-path
    ...
    def getCommand(self, simOrder, customizedCommand): 
        ...
        geometryFile = os.path.abspath(os.path.join(self.json_output, "input_{}.json".format(self.config["SessionID"])))
    ...
    def setDomainMedia(self):
        ...
        if "--save2pt 1" in str(self.config["CustomizedCommands"]):
            ...
            # print("gogogogo")
            self.mcxInput["Domain"]["Media"][4]["mua"] = self.mua_test["4: Skin"]
        ...
        self.mcxInput["Domain"]["Media"][5]["mua"] = self.mua_test["5: Fat"]
        ...
        if self.config["Type"] == "KB_ijv_small_to_large":
            ...
            self.mcxInput["Domain"]["Media"][7]["mua"] = self.mua_test["6: Muscle"]
            self.mcxInput["Domain"]["Media"][7]["mus"] = self.modelParameters["OptParam"]["Muscle"]["mus"]
        elif self.config["Type"] == "KB_ijv_large_to_small":
            ...
            self.mcxInput["Domain"]["Media"][7]["mua"] = self.mua_test["8: IJV"]
        ...
        self.mcxInput["Domain"]["Media"][8]["mua"] = self.mua_test["8: IJV"]
        ...
        self.mcxInput["Domain"]["Media"][9]["mua"] = self.mua_test["9: CCA"]
