...
# -*- coding: utf-8 -*-
"""
Created on Wed Dec 28 15:54:19 2022
...
if __name__ == '__main__' :
    for i in range(mus_start,mus_end+1):
        model_path = os.path.join(folder,"LUT",f"run_{i}","model_parameters.json")
        ...
        path = os.path.join(folder,"LUT",f"run_{i}","post_analysis",f"run_{i}_simulation_result.json")
        num = len(glob(os.path.join(folder,"LUT",f"run_{i}","mcx_output","*")))
